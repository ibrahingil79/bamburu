...
## Notas
- Una tarea "EN CURSO" a la vez (RITUAL). **Pilar 1 — Producto: CERRADO** (P1+P2, P2.1, P2.2, P3 y P4 hechos). Hecha además la **corrección transversal de buscadores/filtros** (2026-06-03). **Pilar 2 — Cliente: EN CURSO** — T1 (saneamiento) ✅, T2 (lista) ✅, T3 (campos de gestión) ✅ y **T4 (Paso 1 motor de cobros, Paso 2 perfiles+próxima acción+DISA, Paso 2.1 gestión de cuenta)** ✅ hechas; siguiente: **T5 — DISA sobre clientes**.
