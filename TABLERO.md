...
## Notas
- Una tarea "EN CURSO" a la vez (RITUAL). **Pilar 1 — Producto: CERRADO** (P1+P2, P2.1, P2.2, P3 y P4 hechos). Hecha además la **corrección transversal de buscadores/filtros** (2026-06-03). **Pilar 2 — Cliente: EN CURSO** — T1 (saneamiento) ✅, T2 (lista) ✅ y T3 (campos de gestión) ✅ hechas; siguiente: **T4 — ficha útil con facturas reales** (histórico facturado y pendiente de cobro; no existe tabla de cobros: pieza a crear).
