...
- ⬜ Pendiente: **activar** la cola (certificado + contraseña en el servicio), anulaciones, subsanación del
  2004, Fase B legal, Facturae (firma/envío, bloqueado por certificado).
