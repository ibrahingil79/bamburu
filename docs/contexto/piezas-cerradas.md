...
- ⬜ Contabilidad — siguiente: **libro diario y libro mayor** (mismo motor), luego modelos 303/130, P&G/balance, conciliación bancaria, bienes de inversión/amortización, cuentas anuales/legalización, acceso gestoría, subcuentas. (Backlog detallado en TABLERO.md.)
