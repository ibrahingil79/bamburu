...
export const CODE_PREFIX = { client: 'CLI-', supplier: 'PROV-', product: 'PROD-', purchase_order: 'OC-', purchase_order_receipt: 'RC-', supplier_return: 'DEV-', stock_transfer: 'TR-', supplier_invoice: 'FRP-', supplier_credit: 'ABP-', quote: 'PRE-' };
