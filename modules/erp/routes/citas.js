  ...
  <div class="modal-overlay" id="mNuevoSvc"><div class="modal" style="max-width:560px">
    ...
    <div class="modal-body">
      ...
      <div class="form-row">
        ...
        <div class="form-group"><label class="form-label">IVA</label><select class="form-control" id="nsIva"><option value="general">General (21%)</option><option value="reducido">Reducido (10%)</option><option value="superreducido">Superreducido (4%)</option><option value="exento">0 % (no equivale a exento)</option></select>${esSalud ? '<div style="margin-top:.35rem;color:var(--text2);font-size:12px">La exención sanitaria no se decide por ser un negocio de salud: el responsable debe confirmar en Productos la titulación habilitante, la finalidad real del servicio y la causa legal antes de facturarlo.</div>' : ''}</div>
      </div>
      <div class="form-row">
