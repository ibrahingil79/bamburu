...
const browser = await puppeteer.launch({ userDataDir: perfilDesechable('verify-mostrador-overstock-browser'),  headless: 'new', executablePath: '/snap/bin/chromium', args: ['--no-sandbox', '--disable-dev-shm-usage', '--disable-gpu'] });
