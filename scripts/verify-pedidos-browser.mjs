...
const browser = await puppeteer.launch({ userDataDir: perfilDesechable('verify-pedidos-browser'),  headless: 'new', executablePath: '/snap/bin/chromium', args: ['--no-sandbox'] });
