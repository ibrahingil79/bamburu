...
const jsErrors = [];
const browser = await puppeteer.launch({ userDataDir: perfilDesechable('verify-u3-errores'),  headless: 'new', executablePath: '/snap/bin/chromium', args: ['--no-sandbox', '--disable-dev-shm-usage', '--disable-gpu'] });
